...
public class StartupConstants {
    ...
    public static String PATH_EPORTFOLIOS = PATH_DATA + "saved_eportfolios/";
    public static String PATH_SAMPLE_IMAGES = PATH_DATA + "images/";
   ...
   // public static String INDEX_HTML_TEMPLATE = PATH_SITES + "indexTemplate.html";
   // public static String SLIDESHOW_JS_TEMPLATE = PATH_SITES + "SlideshowScriptTemplate.js";
   // public static String SLIDESHOW_CSS_TEMPLATE = PATH_SITES + "slideshow_styleTemplate.css";
   // public static String INDEX_HTML = "/index.html";
   // public static String SLIDESHOW_JS = "/Slideshow.js";
   // public static String SLIDESHOW_STYLE = "/slideshow_style.css";
   // public static String VIEW_BACKGROUND = "pattern.png";
    

    // SITE TOOLBAR GUI ICONS
    ...
    public static String ICON_EXIT_PROGRAM = "Exit.png";
  ...
  public static String    CSS_CLASS_WORKSPACE_TOOLBAR;
