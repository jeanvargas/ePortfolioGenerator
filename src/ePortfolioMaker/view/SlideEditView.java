...
import ePortfolioMaker.controller.SlideshowImageController;
import ePortfolioMaker.error.ErrorHandler;
import static ePortfolioMaker.file.ePortfolioFileManager.SLASH;
...
public class SlideEditView extends HBox{
    ...
    SlideshowImageController imageController;
	...
	imageController = new SlideshowImageController();
